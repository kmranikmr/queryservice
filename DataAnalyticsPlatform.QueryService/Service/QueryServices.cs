...
namespace DataAnalyticsPlatform.QueryService.Service
{
    ...
    {
        public static void AddQueryServices(this IServiceCollection service , string p, string digdagConnection, string elastic, string dataservice)// IOptions<ConnectionStringsConfig> optionsAccessor)
        {
